...
func newWord(db *gorm.DB, opts ...gen.DOOption) word {
	...
	_word.Name = field.NewString(tableName, "name")
	_word.GroupID = field.NewString(tableName, "group_id")
...
func (w *word) updateTableName(table string) *word {
	...
	w.GroupID = field.NewString(table, "group_id")
...
func (w *word) WithContext(ctx context.Context) IWordDo { return w.wordDo.WithContext(ctx) }

func (w word) TableName() string { return w.wordDo.TableName() }

func (w word) Alias() string { return w.wordDo.Alias() }

func (w word) Columns(cols ...field.Expr) gen.Columns { return w.wordDo.Columns(cols...) }
