...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Time = field.NewTime(tableName, "time")
	_message.SenderID = field.NewString(tableName, "sender_id")
	_message.GroupID = field.NewString(tableName, "group_id")
	_message.Card = field.NewString(tableName, "card")
	_message.Text = field.NewString(tableName, "text")
	_message.ReplyID = field.NewString(tableName, "reply_id")
	_message.RawJSON = field.NewString(tableName, "raw_json")
	_message.RawMessage = field.NewString(tableName, "raw_message")
...
func (m *message) updateTableName(table string) *message {
	...
	m.Card = field.NewString(table, "card")
	m.Text = field.NewString(table, "text")
	m.ReplyID = field.NewString(table, "reply_id")
	m.RawJSON = field.NewString(table, "raw_json")
	m.RawMessage = field.NewString(table, "raw_message")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["card"] = m.Card
	m.fieldMap["text"] = m.Text
	m.fieldMap["reply_id"] = m.ReplyID
	m.fieldMap["raw_json"] = m.RawJSON
